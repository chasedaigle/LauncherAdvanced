...
package com.launcher.advanced.catalogue;

import java.util.ArrayList;
import java.util.List;

import com.launcher.advanced.ApplicationInfo;
import com.launcher.advanced.LauncherModel;
import com.launcher.advanced.R;
import com.launcher.advanced.catalogue.AppCatalogueFilters.Catalogue;
	...
	public void onClick(View v) {
		if (v == mOkButton) {
			...
			for (int i = 0; i < adapter.getCount(); i++) {
				...
				//la: Change to only store hidden apps
				if (checked)
